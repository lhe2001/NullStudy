...
<c:set var="contextPath" value="${pageContext.request.contextPath}"></c:set>
	...
	<div id = "article_flex">
	<form id="frmSelect" name="frmSelectName" > 
...
<div id = "search">
<%-- 글쓰기 영역 
		 	글쓰기 누르면 /board/writeArticle.do로 글쓰기를 요청해버리고(컨트롤러)
	--%>
	<form method="post" action="${contextPath }/board/articleForm.do"
